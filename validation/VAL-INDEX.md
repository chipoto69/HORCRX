...
| VAL-HERMES-02 | [specs/hermes-binding/BINDING.md](../specs/hermes-binding/BINDING.md) §4.1 | `validation/scripts/gate-hx-06-strip-rehydrate.sh` | covered |
...
| VAL-VESSEL-14 | [specs/vessel-format/SPEC.md](../specs/vessel-format/SPEC.md) §5.1 | `validation/scripts/gate-hx-04-signature-roundtrip.py` | covered |
