...
try:
    ...
    _resolve_model = getattr(_gateway_run, "_resolve_model", None)
    if _resolve_model is None:
        _resolve_model = getattr(_gateway_run, "_resolve_gateway_model", None)
    _resolve_runtime_agent_kwargs = getattr(_gateway_run, "_resolve_runtime_agent_kwargs", None)
    if _resolve_model is None or _resolve_runtime_agent_kwargs is None:
        raise ImportError("gateway.run is missing runtime resolver helpers")
except ImportError:
