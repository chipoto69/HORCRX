...
A7. All resolved open questions (OQ-12..OQ-19) land in `specs/hermes-binding/open-questions-resolved.md` with `accepted` status. Merge is blocked while any of OQ-13 / OQ-15 / OQ-17 / OQ-18 is still pending operator HITL review; those stamps land at PR review. All other OQs must be `accepted` before close (no `accepted-pending-HITL`).
